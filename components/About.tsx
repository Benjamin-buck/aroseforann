  ...
  return (
    <div className="bg-[#0e0e0e] py-20">
      <div className="mx-auto container px-6 lg:px-8">
        ...
        <div className="flex flex-col-reverse lg:flex-row gap-12 items-center font-Outfit">
          <div className="space-y-6 text-lg lg:max-w-[50%] text-gray-300 leading-relaxed">
          ...
          <div className="h-[300px] lg:h-[520px] w-full lg:max-w-[50%]">
            <Image
              src="/ben.JPG"
              width={2000}
              height={1080}
              className="object-cover size-full rounded-2xl shadow-2xl shadow-black/60"
              alt="Band photo"
            />
          </div>
        </div>
