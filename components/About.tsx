  ...
  return (
    <div className="mx-auto container">
      <div className="font-DharmaPunk relative">
        ...
        <h2 className="text-[70px] absolute top-8 max-md:left-10">The Band</h2>
      </div>
      <div className="flex flex-col-reverse lg:flex-row mt-20 items-center font-Outfit">
        <div className="space-y-5 lg:pr-[100px] text-lg lg:max-w-[50%] max-md:px-8">
          <p>
            ...
            with infectious modern melodies. With driving guitars, punchy drums,
            and earworm top lines, the band captures the spirit of the Warped
            Tour era while carving out a fresh sound all their own. Every track
            is a nod to the golden age of pop punk—hook-heavy, high-energy, and
          ...
          <p>
            ...
            Whether you’re moshing in the front row or blasting them on a summer
            drive, A Rose for Ann delivers the kind of pop punk that sticks with
            you long after the final chorus.
          </p>
        </div>
